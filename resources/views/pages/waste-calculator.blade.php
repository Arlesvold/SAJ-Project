...
@section('content')
    ...
    <section class="page-hero"
        style="background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.7)), url('https://images.unsplash.com/photo-1550989460-0adf9ea622e2?auto=format&fit=crop&w=1800&q=80'); background-size: cover; background-position: center; background-attachment: fixed; position: relative;">
        ...
        <div class="page-hero-content" style="position: relative; z-index: 10; color: white; text-align: center;">
            <div class="container">
                ...
                <div class="page-hero-badge"
                    ...
                    <i class="fas fa-circle" style="color: #c8e6c9;"></i> Analisis Sampah
                </div>
                <h1 style="color: white; font-size: 3.5rem; font-weight: 800; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">
                    Kalkulator&nbsp;<span class="highlight"
                        style="color: #a5d6a7; text-shadow: none;">Sampah</span>&nbsp;Kelas</h1>
